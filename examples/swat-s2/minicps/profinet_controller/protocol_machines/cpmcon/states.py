...
class Connection:
    ...
    def write(self, parameterList):
        self._state.write(parameterList)

    def announceEndPrm(self):
        self._state.announceEndPrm()

    def ackApplicationReady(self):
...
class CPMCONState(ABC):
    ...
    @context.setter
    def context(self, context: Connection) :
...
class CPMCONIdleAppRdyState(CPMCONState):
    ...
    def ackApplicationReady(self):
        ...
        print(f"udp and host {self.context.ip} and port 34964")
        sniff(
